...
<i class="fa fa-print" onclick="printOwner('${owner.code}')"></i>
...
<div><i class="fa fa-calendar"></i> ${owner.dob}</div>
</div>
...
<div class="field" style="grid-column: 1 / -1;">
        ...
        <select id="petLastStaff">
          ...
          <option>Dr. Blessedxie Bolambot</option>
          <option>Dr. Steven Strange</option>
          <option>Dr. Otto Octivus</option>
...
function printOwner(code){
  const owner = owners.find(o => o.code === code);
  if(!owner) return;

  document.getElementById('regName').textContent = owner.name;
  document.getElementById('regPhone').textContent = owner.phone;
  document.getElementById('regDob').textContent = owner.dob;
  document.getElementById('regLocation').textContent = owner.location;
  document.getElementById('regCode').textContent = owner.code;
